/*
3.Создать массив из заданного пользователем количества элементов
и заполнить его числами из промежутка заданного пользователем.
Посчитать количество четных чисел в данном массиве.
Посчитать количество простых чисел в массиве.
Вывести в одном сообщении массив, и результаты.
*/
